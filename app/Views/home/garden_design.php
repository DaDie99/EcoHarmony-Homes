...
<head>
    <base href="<?= base_url() ?>/">
    <meta charset="UTF-8">
    <title>Garden Design Services - EcoHarmony Homes</title>
...
<body>
    ...
    <div class="bg-image">
        <div class="overlay">
            <h1 class="display-4 text-white">Garden Design Services</h1>
            <p class="lead">Explore our range of professional garden design services to transform your outdoor space.</p>
        </div>
    </div>
    ...
    <!-- Garden Design Services List Section -->
    <div class="container mt-4">
        <div class="row">
            <?php if (!empty($services)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No garden design services found. Please adjust your filters.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        function applyFilter() {
            ...
            window.location.href = `<?= site_url('garden_design?sortBy=') ?>` + sortBy;
        }
        ...
        $(document).ready(function() {
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: `<?= site_url('garden_design/getServiceDetails') ?>/${serviceId}`,
                    method: 'GET',
