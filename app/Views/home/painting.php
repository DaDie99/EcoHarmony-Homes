...
<head>
    <base href="<?= base_url() ?>/">
    <meta charset="UTF-8">
    <title>Painting Services - EcoHarmony Homes</title>
...
<body>
    ...
    <div class="bg-image">
        <div class="overlay">
            <h1 class="display-4 text-white">Painting Services</h1>
            <p class="lead">Explore our expert painting services to beautify your home.</p>
        </div>
    </div>
    ...
    <!-- Painting Services List Section -->
    <div class="container mt-4">
        <div class="row">
            <?php if (!empty($services)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No painting services found. Please adjust your filters.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        function applyFilter() {
            ...
            window.location.href = `<?= site_url('painting?sortBy=') ?>` + sortBy;
        }
        ...
        $(document).ready(function() {
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: `<?= site_url('painting/getServiceDetails') ?>/${serviceId}`,
                    method: 'GET',
