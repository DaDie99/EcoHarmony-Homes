...
body {
    ...
    background: linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('../images/background.jpg') no-repeat center center fixed; /* Add a background image here */
...
.welcome-text {
    font-size: 24px;
    margin-bottom: 20px;
    color: #ff8c00; /* Use a vibrant orange color */
}
