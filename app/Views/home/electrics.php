...
<head>
    <base href="<?= base_url() ?>/">
    <meta charset="UTF-8">
    <title>Electrics Services - EcoHarmony Homes</title>
...
<div class="bg-image">
    <div class="overlay">
        <h1 class="display-4 text-white">Quality Electrics Services</h1>
        <p class="lead">Explore our comprehensive range of electrics services for your needs.</p>
    </div>
</div>
...
<!-- Electrics Service List Section -->
<div class="container properties-list">
    <?php if (!empty($services)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No electrics services found. Please adjust your filters.</p>
    <?php endif; ?>
</div>
