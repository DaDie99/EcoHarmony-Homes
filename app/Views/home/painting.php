...
<div class="bg-image">
    <div class="overlay">
        <h1 class="display-4 text-white">Professional Painting Services</h1>
        <p class="lead">Enhance your space with our expert painting services.</p>
    </div>
</div>
