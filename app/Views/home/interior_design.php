...
<head>
    <base href="<?= base_url() ?>/">
    <meta charset="UTF-8">
    <title>Interior Design - EcoHarmony Homes</title>
...
<body>
    ...
    <div class="bg-image">
        <div class="overlay">
            <h1 class="display-4">Interior Design Services</h1>
            <p class="lead">Explore our range of interior design services tailored to your needs.</p>
        </div>
    </div>
    ...
    <!-- Interior Design Services List Section -->
    <div class="container mt-4">
        <div class="row">
            <?php if (!empty($services)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No interior design services found. Please adjust your filters.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        function applyFilter() {
            ...
            window.location.href = `<?= site_url('interior_design?sortBy=') ?>` + sortBy;
        }
        ...
        $(document).ready(function() {
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: `<?= site_url('interior_design/getServiceDetails') ?>/${serviceId}`,
                    method: 'GET',
