...
<body>
    ...
    <div class="bg-image">
        <div class="overlay">
            <h1 class="display-4 text-white">Furniture Services</h1>
            <p class="lead">Explore our wide range of furniture services tailored to your style and needs.</p>
        </div>
    </div>
    ...
    <!-- Furniture Services List Section -->
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: `<?= site_url('furniture/getServiceDetails') ?>/${serviceId}`,
                    method: 'GET',
