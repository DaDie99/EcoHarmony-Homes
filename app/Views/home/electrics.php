...
<head>
    <base href="<?= base_url() ?>/">
    <meta charset="UTF-8">
    <title>Electrical Services - EcoHarmony Homes</title>
...
<body>
    ...
    <div class="bg-image">
        <div class="overlay">
            <h1 class="display-4 text-white">Electrical Services</h1>
            <p class="lead">Explore our comprehensive electrical services tailored to your needs.</p>
        </div>
    </div>
    ...
    <!-- Electrical Services List Section -->
    <div class="container mt-4">
        <div class="row">
            <?php if (!empty($services)): ?>
                ...
                <?php endforeach; ?>
            <?php else: ?>
                <p>No electrical services found. Please adjust your filters.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <script>
        function applyFilter() {
            ...
            window.location.href = `<?= site_url('electrics?sortBy=') ?>` + sortBy;
        }
        ...
        $(document).ready(function() {
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: `<?= site_url('electrics/getServiceDetails') ?>/${serviceId}`,
                    method: 'GET',
