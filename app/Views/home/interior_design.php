...
<div class="bg-image">
    <div class="overlay">
        <h1 class="display-4 text-white">Interior Design Services</h1>
        <p class="lead">Explore our premium interior design services for beautiful spaces.</p>
    </div>
</div>
...
<!-- Interior Design Service List Section -->
