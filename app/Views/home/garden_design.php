...
<div class="bg-image">
    <div class="overlay">
        <h1 class="display-4 text-white">Beautiful Garden Design Services</h1>
        <p class="lead">Transform your outdoor space with our expert garden design services.</p>
    </div>
</div>
...
<!-- Garden Design Service List Section -->
