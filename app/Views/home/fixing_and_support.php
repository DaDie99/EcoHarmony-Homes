...
<div class="bg-image">
    <div class="overlay">
        ...
        <p class="lead">Explore our professional fixing and support services.</p>
    </div>
</div>
...
<!-- Fixing & Support Service List Section -->
<div class="container properties-list">
    <?php if (!empty($services)): ?>
        ...
        <?php endforeach; ?>
    <?php else: ?>
        <p>No fixing & support services found. Please adjust your filters.</p>
    <?php endif; ?>
</div>
